...
clip.addIncident(moveLeft("0%", ".problem-info > .title", 500), 2400);
clip.addIncident(moveLeft("0%", ".problem-info > .subtitle ", 500), 2600);
clip.addIncident(
...
clip.addIncident(moveTop("-100%", ".problem-info", 500), 6700);
clip.addIncident(
...
clip.addIncident(moveRight("0%", ".solution-info > .title", 500), 7200);
clip.addIncident(moveRight("0%", ".solution-info > .subtitle ", 500), 7400);
clip.addIncident(
...
clip.addIncident(moveTop("-100%", ".solution-info", 500), 11500);
clip.addIncident(moveRight("100%", ".solution-list-root", 500), 11500);
...
clip.addIncident(moveTop("140%", ".product .img", 500), 13900);
clip.addIncident(opacity(".product", 1), 14400);
//appear timeline slide
clip.addIncident(heightMove("100%", ".timeline > .lt", 1100), 14400);
clip.addIncident(widthMove("50%", ".timeline > .rb", 500), 14400);
clip.addIncident(moveRight("0%", ".timeline-info > .title", 500), 14400);
clip.addIncident(moveRight("0%", ".timeline-info > .description ", 500), 14600);
clip.addIncident(moveTop("0px", ".step-title", 500, "@stagger(0, 400)"), 14400);
clip.addIncident(moveTop("0px", ".step-date", 500, "@stagger(0, 400)"), 14800);
//remove timeline slide
clip.addIncident(moveTop("100%", ".timeline > .lt", 400), 17700);
clip.addIncident(moveLeft("-50%", ".calendar", 500), 18100);
clip.addIncident(moveTop("-100%", ".timeline-info", 500), 17800);
clip.addIncident(widthMove("0%", ".timeline > .rb", 500), 17800);
clip.addIncident(opacity(".timeline", 1), 18600);
//appear timing slide
clip.addIncident(moveTop("13%", ".timing > .title", 700), 18600);
...
clip.addIncident(moveLeft("-50%", ".timing > .title", 900), 21900);
clip.addIncident(moveLeft("-50%", ".timing > .timing-info", 900), 22000);
...
clip.addIncident(moveLeft("5%", ".market-size-info > .title", 500), 30300);
clip.addIncident(moveLeft("15%", ".market-size-info > .subtitle", 500), 30300);
clip.addIncident(
  moveBottom("30%", ".market-size-list-root > .flex-column", 500),
  30300
);
clip.addIncident(
  opacity1(".market-size-number", 500, "@stagger(0, 600)"),30600);
clip.addIncident(opacity1(".market-size-tag", 500, "@stagger(0, 600)"), 30800);
//remove market-size slide
clip.addIncident(moveBottom("100%", ".market-size-info", 400), 33900);
clip.addIncident(moveBottom("-40%", ".market-size-list-root", 400), 33900);
...
clip.addIncident(opacity1(".direct-competitors-list-root > .item",100,"@stagger(0, 500)"),35500)
clip.addIncident(opacity1(".indirect-competitors-list-root > .item",100,"@stagger(0, 500)"),35500)
//remove competitors slide
clip.addIncident(moveRight("100%",".competitors > .rb",400),38100)
clip.addIncident(moveLeft("100%",".direct",400),38100)
clip.addIncident(moveLeft("-100%",".indirect",400),38100)
...
clip.addIncident(moveBottom("8%",".competive-advantages > .title",400), 38500)
clip.addIncident(widthMove("33%",".competive-advantages > .lt",400),38500)
//remove competive-advantages slide
clip.addIncident(moveTop("-100px",".competive-advantages-title,.competive-advantages-description",400),41800)
clip.addIncident(moveLeft("-30%",".competive-advantages > .title",400),41800)
...
clip.addIncident(moveTop("8%",".competitor-approach > .title",500),42200)
clip.addIncident(
...
clip.addIncident(moveTop("-100px",".competitor-approach-title,.competitor-approach-description",400),45600)
clip.addIncident(moveLeft("100%",".competitor-approach-list-root",500),46000)
clip.addIncident(moveLeft("-50%",".competitor-approach > .title",500),46000)
clip.addIncident(opacity(".competitor-approach",1),46500)
//appear model slide
clip.addIncident(moveLeft("0%",".model-info > .title",400),46500)
clip.addIncident(moveLeft("0%",".model-info > .subtitle",400),46800)
clip.addIncident(moveRight("0%",".model .item",400, "@stagger(0, 600)"),46500)
clip.addIncident(opacity1(".model-description-wrapper",300,"@stagger(0, 600)"),46900)
//remove model slide
clip.addIncident(opacity(".model-description-wrapper",300,"@stagger(0, 600)"),49800)
clip.addIncident(moveRight("-150%",".model .item",400, "@stagger(0, 600)"),50100)
clip.addIncident(moveLeft("-100%",".model-info",500),51100)
clip.addIncident(opacity(".model",1),51600)
//appear team slide
clip.addIncident(moveLeft("5%",".team > .title",400),51600)
...
clip.addIncident(widthMove("110%",".team .lt",500),53100)
//remove team slide
clip.addIncident(moveLeft("100%",".team-list-root",500),56600)
clip.addIncident(moveLeft("-60%",".team > .title",400),56700)
clip.addIncident(opacity(".team",1),57100)
//appear future slide
clip.addIncident(moveLeft("0%",".future-info > .title",400),57100)
clip.addIncident(moveLeft("0%",".future-info > .subtitle",400),57400)
...
//remove future slide
clip.addIncident(moveLeft("-100%",".future-info",400),60800)
clip.addIncident(moveTop("-100px",".future-title,.future-description",400),60800)
